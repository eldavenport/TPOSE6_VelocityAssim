"""
Utility functions for loading MITgcm control variables and sensitivities into xarray DataArrays.
...
def load_single_control(data_dir, var_name, iteration, grid_ds=None):
    """
